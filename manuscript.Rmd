...
The aims of this study are two-fold: firstly, to evaluate whether geographic access to parkrun events in England igeographic access to parkrun events in England is equitable across areas with different levels of deprivation. Secondly, to identify 200 optimal locations for future events in order geographic access to parkrun events in England is equitable across areas with different levels of deprivation. Secondly, to identify 200 optimal locations for future events in order improve geographic access, in particular for deprived communities.
...
Our analysis has not been concerned with confounding factors, as we were interested only in determining to what extent deprived communities have access to parkrun events - not what factors independently explain access more generally. It should be noted, however, that a contributing factor for the negative relationship between IMD and access is likely to be population density: deprived areas cluster in ubran areas, where also most parkun events take place. Rural areas, on the other hand, generally have worse geographical access as the crow flies.

There are several strengths of this study that derserve metion. Firstly, it is the first study of geographic access to parkrun in England - therefore the approach is novel and the data untapped. Secondly the analysis makes use of large and rich datasets, with over 30,000 LSOA and over 400 existing parkrun events it is unlikely that individual outliers are affecting the results. However, there are also limitations. Most importantly geographic access is not measured as travel distance, or travel time. In some cases, for example where natural barriers like lakes or rivers block routes, the actual distance travelled may be far in excess of the distance as the crow flies. Also, in rural areas where car use is more prevalent travel time may be shorter, despite travel distances being longer. Further investigation could determine how perceptions of access change with distance in different settings (e.g. rural vs urban).
...
The main finding, that geographical access to parkrun events is better in more deprived communities, is surprising given that in a previous study we found that participation in parkrun has a strong socioeconomic gradient with considerably higher participation rates in more affluent areas. About a third of all participants came from LSOAs in the least deprived quintile, while only a third came from the most deprived quintile.[@smithschneider; @schneidersmith] This suggests that providing the opportunity to participate in parkrun events, while a necessary first step to enable participation, has not been sufficient to engage deprived communities.
...
parkrun's stated mission is to create a 'healthier, happier planet' and so far they have been hugely successful in encouraging physical activity worldwide.[@parkrun2017] Our analysis has furthermore shown that parkrun events are, in principle, available to anyone, irrespective of their socio-economic background. However, the extent of parkrun's overall impact on health inequalities will be dependent on how well they are able to understand and overcome barriers to participation for deprived communties.
